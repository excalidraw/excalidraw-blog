...
Excalidraw works well with the operating system's clipboard. Entire Excalidraw drawings or also just individual objects can be copied and pasted in `image/png` and `image/svg+xml` formats, allowing for an easy integration with other native tools like [Inkscape](https://inkscape.org/) or Web-based tools like [SVGOMG](https://jakearchibald.github.io/svgomg/).
